...
<head>
    ...
    <link rel="stylesheet" href="Inspections_page.css">
...
<body>
    ...
    <div class="container">
        ...
        <div id="content" style="width:100%;">
          ...
          <div class="table-responsive">
            ...
            <tr class="head">
                ...
                <th scope="col">Est. Area of service</th>
        ...
        <tbody>
                ...
                ?>
                <tr>
                    <td><?php echo $rows['inspect_id'];?></td>
                    <td><?php echo $rows['customer_id'];?></td>
                    <td><?php echo $rows['pref_date_time'];?></td>
                    <td><?php echo $rows['problem'];?></td>
                    <td><?php echo $rows['serv_id'];?></td>
                    <td><?php echo $rows['est_area_in_sqft'];?></td>
