...
// $date = mysqli_query($con,"SELECT * FROM inspection");
// $datefetch = mysqli_fetch_array($date);
//     if($datefetch['pref_date_time']){
    
//     }
//     else
//     {
//         $_SESSION['datetime'] = $datefetch['pref_date_time'];
//     }
$flag=false;
?>
<!-- To update address, city, state and pin, datetime -->
<?php 
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Book Inspection</h2>  
                </div>
            ...
            <div class="container-fluid px-4">
                ...
                if($flag)
                {
                    echo '<div class="alert alert-success py-1 col-5"role="alert">    
                        <i class="fas fa-check me-2"></i><span>Inspection Booked, You will receive a call shortly!!!</span>
                        </div>';
                }
                ?>
                <div class="mb-4">
                    ...
                    <form class="row g-3" method="POST">
                        ...
                        <div class="col-6">
                            <label for="datetime" class="form-label">Select date and time for inspeciton</label>
